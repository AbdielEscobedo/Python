import cv2
import os
#Importamos la libreria OS para poder crear carpetas y creamos la carpeta en caso de no existir
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        #al detectar un rostro nos da la opción de oprimir s para guardar una imagen del rostro
        if k == ord('s'):
            #podriamos cambiar el nombre par almacenar las imagenes de un rostro especifico
